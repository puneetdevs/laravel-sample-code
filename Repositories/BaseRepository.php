...
abstract class BaseRepository implements RepositoryContract
{
    ...
    /**
     * Add a simple where array clause to the query.
     *
     * @param string $column
     * @param string $value
     * @param string $operator
     ...
     * @return $this
     */
    public function whereMultipal($whereData)
    {
        if(!empty($whereData)){
    ...
    */
    ...
    {
        $this->whereYears[] = compact('column', 'value', 'operator');
    ...
    protected function setClauses()
    {
        ...
        foreach ($this->whereYears as $whereYear) {
            $this->query->whereYear($whereYear['column'], $whereYear['operator'], $whereYear['value']);
        }
